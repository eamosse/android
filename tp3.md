...
> Utilisez le viewBinding 

2. Ajouter un layout pour dessiner la vue du fragment ``add_neighbor.xml``

> Modifiez le layout du fragment pour qu'il ressemble à l'imge ci-dessous 
...
>> Bonus, quand l'utilisateur rempli le champ Image avec, afficher automatiquement un visuel de l'image à la place de l'image par défaut tout en haut. 
...
- Modifiez le fragment de la liste des voisins pour instercepter le clique sur le bouton flottant
...
### Ajouter une toolbar 
Dans une application Android, une toolbar permet de gérer la barre d'action qui modélise le titre des écrans, ou les options de navigations. 

- Modifiez le layout de l'activité pour y ajouter une toolbar. 
